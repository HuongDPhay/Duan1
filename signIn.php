...
<body>
    <div class="">
        <div class="container mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-1/2">
            <a href="index.html"><i class="fas fa-arrow-circle-left text-3xl text-blue-700"></i></a>
            ...
            <form action="" method="post">
                ...
                <a href="" class="font-bold text-sm text-blue-400 hover:text-blue-700 mb-6">Forgot password?</a>
